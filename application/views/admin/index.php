    ...
    <div class="container-scroller d-flex">
                ...
                <div class="card-body card-body-padding d-flex align-items-center justify-content-between">
                    <div class="ps-lg-1">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="<?php echo base_url('assets/template/https://www.bootstrapdash.com/product/spica-admin/?utm_source=organic&utm_medium=banner&utm_campaign=buynow_demo');?>"
                                target="_blank" class="btn me-2 buy-now-btn border-0">Get Pro</a>
                        </div>
                    </div>
                    <div class="d-flex align-items-center justify-content-between">
                        <a
                            href="<?php echo base_url('assets/template/https://www.bootstrapdash.com/product/spica-admin/');?>"><i
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('assets/template/index.html');?>">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse"
                        href="<?php echo base_url('assets/template/#ui-basic');?>" aria-expanded="false"
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link"
                                    href="<?php echo base_url('admin/button');?>">Buttons</a></li>
                            <li class="nav-item"> <a class="nav-link"
                                    href="<?php echo base_url('assets/template/pages/ui-features/typography.html');?>">Typography</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    <a class="nav-link"
                        href="<?php echo base_url('assets/template/pages/forms/basic_elements.html');?>">
                        <i class="mdi mdi-view-headline menu-icon"></i>
                        <span class="menu-title">Form elements</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('assets/template/pages/charts/chartjs.html');?>">
                        <i class="mdi mdi-chart-pie menu-icon"></i>
                        <span class="menu-title">Charts</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('assets/template/pages/tables/basic-table.html');?>">
                        <i class="mdi mdi-grid-large menu-icon"></i>
                        <span class="menu-title">Tables</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('assets/template/pages/icons/mdi.html');?>">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="<?php echo base_url('assets/template/#auth');?>"
                    ...
                    <div class="collapse" id="auth">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link"
                                    href="<?php echo base_url('assets/template/pages/samples/login.html');?>"> Login
                                </a></li>
                            <li class="nav-item"> <a class="nav-link"
                                    href="<?php echo base_url('assets/template/pages/samples/login-2.html');?>"> Login 2
                                </a></li>
                            <li class="nav-item"> <a class="nav-link"
                                    href="<?php echo base_url('assets/template/pages/samples/register.html');?>">
                                    Register </a></li>
                            <li class="nav-item"> <a class="nav-link"
                                    href="<?php echo base_url('assets/template/pages/samples/register-2.html');?>">
                                    Register 2 </a></li>
                            <li class="nav-item"> <a class="nav-link"
                                    href="<?php echo base_url('assets/template/pages/samples/lock-screen.html');?>">
                                    Lockscreen </a></li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url('assets/template/docs/documentation.html');?>">
                ...
                <li class="nav-item">
                    <a class="nav-link"
                        href="<?php echo base_url('assets/template/https://www.bootstrapdash.com/product/spica-admin/');?>">
                ...
                <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                    ...
                    <div class="navbar-brand-wrapper">
                        <a class="navbar-brand brand-logo"
                            href="<?php echo base_url();?>assets/template/index.html"><img
                                src="<?php echo base_url('assets/template/images/logo.svg');?>" alt="logo" /></a>
                        <a class="navbar-brand brand-logo-mini"
                            href="<?php echo base_url();?>assets/template/index.html"><img
                                src="<?php echo base_url('assets/template/images/logo-mini.svg');?>" alt="logo" /></a>
                    </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img src="<?php echo base_url('assets/template/images/faces/face4.jpg');?>"
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img src="<?php echo base_url('assets/template/images/faces/face2.jpg');?>"
                                            alt="image" class="profile-pic">
                                    </div>
                                    <div class="preview-item-content flex-grow">
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img src="<?php echo base_url('assets/template/images/faces/face3.jpg');?>"
                                            alt="image" class="profile-pic">
                                    </div>
                                    <div class="preview-item-content flex-grow">
                    ...
                    <ul class="navbar-nav navbar-nav-right">
                        <li class="nav-item nav-profile dropdown">
                            <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
                                <img src="<?php echo base_url('assets/template/images/faces/face5.jpg');?>"
                                    alt="profile" />
                                                    ...
                                                    <ul class="nav nav-pills nav-pills-custom justify-content-md-end"
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link active" id="pills-home-tab-custom"
                                                                data-toggle="pill"
                                                                href="<?php echo base_url('assets/template/#pills-health');?>"
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link" id="pills-profile-tab-custom"
                                                                data-toggle="pill"
                                                                href="<?php echo base_url('assets/template/#pills-career');?>"
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link" id="pills-contact-tab-custom"
                                                                data-toggle="pill"
                                                                href="<?php echo base_url('assets/template/#pills-music');?>"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="py-1">
                                                        <img src="<?php echo base_url('assets/template/images/faces/face1.jpg');?>"
                                                            alt="image" />
                                                    </td>
                                                    <td>
                                                        Herman Beck
                                                ...
                                                <tr>
                                                    <td class="py-1">
                                                        <img src="<?php echo base_url('assets/template/images/faces/face6.jpg');?>"
                                                            alt="image" />
                                                    </td>
                                                    <td>
                                                        John Doe
                                                ...
                                                <tr>
                                                    <td class="py-1">
                                                        <img src="<?php echo base_url('assets/template/images/faces/face7.jpg');?>"
                                                            alt="image" />
                                                    </td>
                                                    <td>
                                                        Henry Tom
                        ...
                        <div class="card-body">
                            <div class="d-sm-flex justify-content-center justify-content-sm-between py-2">
                                <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright ©
                                    <a href="<?php echo base_url('assets/template/https://www.bootstrapdash.com/');?>"
